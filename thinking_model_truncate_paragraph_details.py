...
# %%
# def removing_extra_text(response_list, stop_sequences):
#     response_truncated_list = []
#     for response in response_list:
#         for stop_seq in stop_sequences:
#             if stop_seq in response:
#                 response = response.split(stop_seq)[0]
#         response_truncated_list.append(response)
#     return response_truncated_list
...
# %%
# answer_true = [string_to_number(ans.split("#### ")[-1]) for ans in test_data["answer"]]
...
print([answer_true_i, answer_base, i_para, answer_modified])

# %%
# print(response_base)
# print("----" * 10)
# print(lines_after_tag[i_para-1])
# print("----" * 10)
# print(modified_list[0])

# %%
modified_text_3 = modified_list[0]
modified_text_3 = '\n'.join(modified_text_3.split('\n')[:-22]) + "\n   Wait, that doesn't sound right, let's backtrack and try another path.\n"

modified_list_3, generated_tokens_3, input_len_3, max_len_3 = generate_with_cot(
    modified_text_3, temperature, max_length = input_len + max_new_tokens + 1, formatted = True
)
if generated_tokens_3[0,-1] == tokenizer.eos_token_id:
    answer_modified_3 = extract_last_integer_efficient(modified_list_3[0])
else:
    answer_modified_3 = None
print([answer_true_i, answer_base, answer_modified_3])

# %%
modified_text_4 = modified_list[0]
modified_text_4 = '\n'.join(modified_text_4.split('\n')[:-22]) + "\n   Wait, that doesn't sound right, let's backtrack to the beginning and try another path.\n"

modified_list_4, generated_tokens_4, input_len_4, max_len_4 = generate_with_cot(
    modified_text_4, temperature, max_length = input_len + max_new_tokens + 1, formatted = True
)
if generated_tokens_4[0,-1] == tokenizer.eos_token_id:
    answer_modified_4 = extract_last_integer_efficient(modified_list_4[0])
else:
    answer_modified_4 = None
print([answer_true_i, answer_base, answer_modified_4])

# %%
modified_text_5 = modified_list[0]
modified_text_5 = '\n'.join(modified_text_5.split('\n')[:-22]) + "\n   I think I've gone wrong, let's list out all relevant factors, and hope this helps me choose the next step better:\n"

modified_list_5, generated_tokens_5, input_len_5, max_len_5 = generate_with_cot(
    modified_text_5, temperature, max_length = input_len + max_new_tokens + 1, formatted = True
)
if generated_tokens_5[0,-1] == tokenizer.eos_token_id:
    answer_modified_5 = extract_last_integer_efficient(modified_list_5[0])
else:
    answer_modified_5 = None
print([answer_true_i, answer_base, answer_modified_5])

# %%
modified_text_6 = modified_list[0]
modified_text_6 = '\n'.join(modified_text_6.split('\n')[:-22]) + "\n   I think I've gone wrong, let's list out all relevant factors, and hope this helps me choose the next step better: <think>\n"

modified_list_6, generated_tokens_6, input_len_6, max_len_6 = generate_with_cot(
    modified_text_6, temperature, max_length = input_len + max_new_tokens + 1, formatted = True
)
if generated_tokens_6[0,-1] == tokenizer.eos_token_id:
    answer_modified_6 = extract_last_integer_efficient(modified_list_6[0])
else:
    answer_modified_6 = None
print([answer_true_i, answer_base, answer_modified_6])


# %%
modified_text_7 = modified_list[0]
modified_text_7 = '\n'.join(modified_text_7.split('\n')[:-22]) + "\n   I think I've gone wrong, and let's go back to our previous results:\n"

modified_list_7, generated_tokens_7, input_len_7, max_len_7 = generate_with_cot(
    modified_text_7, temperature, max_length = input_len + max_new_tokens + 1, formatted = True
)
if generated_tokens_7[0,-1] == tokenizer.eos_token_id:
    answer_modified_7 = extract_last_integer_efficient(modified_list_7[0])
else:
    answer_modified_7 = None
print([answer_true_i, answer_base, answer_modified_7])

# %%
# %%
for i_para in paragraph_indices:
    modified_text_8 = lines_before_tag + '\n'.join(lines_after_tag[:i_para+1]) + '\n'
    modified_text_8 += "I think I've gone wrong, let's list out all relevant factors, and maybe go back to our previous thinking results: <think>\n"

    modified_list_8, generated_tokens_8, input_len_8, max_len_8 = generate_with_cot(
        modified_text_8, temperature, max_length = input_len + max_new_tokens + 1, formatted = True
    )
    if generated_tokens_8[0,-1] == tokenizer.eos_token_id:
        answer_modified_8 = extract_last_integer_efficient(modified_list_8[0])
    else:
        answer_modified_8 = None
    print([answer_true_i, answer_base, i_para, answer_modified_8])
